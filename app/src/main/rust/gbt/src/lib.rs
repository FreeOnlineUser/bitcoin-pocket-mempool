...
impl GbtResult {
    ...
    pub fn to_jni<'a>(&self, env: &mut JNIEnv<'a>) -> jni::errors::Result<JObject<'a>> {
        // Create the result object
        let gbt_result_class = env.find_class("com/pocketmempool/mempool/GbtResult")?;
        let constructor = env.get_method_id(&gbt_result_class, "<init>", "()V")?;
        let result_obj = unsafe { env.new_object_unchecked(&gbt_result_class, constructor, &[])? };
        ...
        env.set_field(&result_obj, "blocks", "[[I", JValueGen::Object(&JObject::from(blocks_array)))?;
        ...
        env.set_field(&result_obj, "blockWeights", "[I", JValueGen::Object(&JObject::from(weights_array)))?;
        ...
        env.set_field(&result_obj, "clusters", "[[I", JValueGen::Object(&JObject::from(clusters_array)))?;
        ...
        env.set_field(&result_obj, "rates", "[[D", JValueGen::Object(&JObject::from(rates_array)))?;
        ...
        env.set_field(&result_obj, "overflow", "[I", JValueGen::Object(&JObject::from(overflow_array)))?;
...
// Initialize logging
#[no_mangle]
pub extern "C" fn Java_com_pocketmempool_mempool_GbtGenerator_initNative(
    _env: JNIEnv,
    _class: JClass,
) {
...
#[no_mangle]
pub extern "C" fn Java_com_pocketmempool_mempool_GbtGenerator_createNative(
    _env: JNIEnv,
    _class: JClass,
    max_block_weight: u32,
    max_blocks: u32,
...
#[no_mangle]
pub extern "C" fn Java_com_pocketmempool_mempool_GbtGenerator_destroyNative(
    _env: JNIEnv,
    _class: JClass,
    ptr: jlong,
) {
...
#[no_mangle]
pub extern "C" fn Java_com_pocketmempool_mempool_GbtGenerator_makeNative(
    mut env: JNIEnv,
    _class: JClass,
    ptr: jlong,
...
#[no_mangle]
pub extern "C" fn Java_com_pocketmempool_mempool_GbtGenerator_updateNative(
    mut env: JNIEnv,
    _class: JClass,
    ptr: jlong,
